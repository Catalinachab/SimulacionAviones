...
def main():
    ...
    rows = [] 
    runs = [
        Path("plots/plots-ej6/run_p=0.02_sim=50000.json"),
        Path("plots/plots-ej6/run_p=0.1_sim=50000.json"),
        Path("plots/plots-ej6/run_p=1_sim=50000.json"),
        Path("plots/plots-ej6/run_p=0.2_sim=50000.json"),
        Path("plots/plots-ej6/run_p=0.5_sim=50000.json")
    ]
    for fp in runs:
        ...
        print("prop_desviados:", p_mvd_per_detect )
        ...
        print("atraso promedio:", atraso_mean)
        rows.append(dict(
        lambda_=p,
    ...
    with pd.ExcelWriter("plots/plots-ej6/resumen_lambda.xlsx", engine="openpyxl") as w:
    ...
    plt.grid(True)
    plt.savefig("plots/plots-ej6/plot_congestion_vs_lambda.png", bbox_inches="tight")
    ...
    plt.grid(True)
    plt.savefig("plots/plots-ej6/plot_prob_congestion_vs_lambda.png", bbox_inches="tight")
   ...
   # 3) % de aviones desviados a Montevideo vs λ
    ...
    plt.grid(True)
    plt.savefig("plots/plots-ej6/plot_mvd_vs_lambda.png", bbox_inches="tight")
   ...
   # 4) Atraso promedio por avión (min) vs λ
    ...
    plt.grid(True)
    plt.savefig("plots/plots-ej6/plot_atraso_vs_lambda.png", bbox_inches="tight")
